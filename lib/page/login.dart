...
import 'package:pangping_162/page/show_product.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Future<String?> _authUser(LoginData data) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://642021162.pungpingcoding.online/api/login'),
        body: {
          'email': data.name,
  ...
  Future<String?> _signupUser(SignupData data) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://642021162.pungpingcoding.online/api/register'),
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      // title: 'NUTTY CAFE',
      theme: LoginTheme(
          primaryColor: Color.fromARGB(151, 177, 155, 140),
          ...
          pageColorDark: Color.fromARGB(255, 255, 255, 255)),
      logo: const AssetImage('assets/images/pangping.png'),
      onLogin: _authUser,

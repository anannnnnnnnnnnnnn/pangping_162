...
import 'package:pangping_162/page/add_product.dart';
import 'package:pangping_162/page/edit_product.dart';
...
class _ShowProductState extends State<ShowProduct> {
  ...
  Future<void> getList() async {
    products = [];
    var url = Uri.parse('https://642021162.pungpingcoding.online/api/product');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(155, 117, 104, 94),
        actions: [
          Row(
            children: [
  ...
  Future<void> deleteProduct(int id) async {
    var url =
        Uri.parse('https://642021162.pungpingcoding.online/api/product/$id');
  ...
  Future<void> logout(BuildContext context) async {
    ...
    var url = Uri.parse('https://642021162.pungpingcoding.online/api/logout');
